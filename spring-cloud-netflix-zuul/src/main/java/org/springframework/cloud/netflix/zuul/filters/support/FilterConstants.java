...
public final class FilterConstants {
	...
	/**
	 * Zuul {@link com.netflix.zuul.context.RequestContext} key for use in
	 * {@link org.springframework.cloud.netflix.zuul.filters.pre.ServletDetectionFilter}.
	 */
	...
	/**
	 * Zuul {@link com.netflix.zuul.context.RequestContext} key for use in
	 * {@link org.springframework.cloud.netflix.zuul.filters.route.RibbonRoutingFilter}.
	 */
	public static final String REQUEST_ENTITY_KEY = "requestEntity";

	/**
	 * Zuul {@link com.netflix.zuul.context.RequestContext} key for use in to override the
	 * path of the request.
	 */
